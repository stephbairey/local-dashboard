/* tides.js — Moon + Tides + Sunrise/Sunset */
(function(){
  ...
  R("slide-tides", function renderTides(tideDataFromApp){
    ...
    Promise.allSettled([
      ...
      try {
        ...
        const sunrise = stripClock(sun.sunrise || sun?.results?.sunrise || "");
        const sunset  = stripClock(sun.sunset  || sun?.results?.sunset  || "");
        ...
        el.innerHTML = `
          ...
          <!-- Bottom row: Sunrise and Sunset -->
          <div class="tide-list grid">
            <div class="card tide-mini">
              <div class="mini-label">Sunrise</div>
              <div class="mini-value">${sunrise ? EH(sunrise) : "—"}</div>
            </div>
            <div class="card tide-mini">
              <div class="mini-label">Sunset</div>
              <div class="mini-value">${sunset ? EH(sunset) : "—"}</div>
            </div>
          </div>
        `;
      } catch(e){
